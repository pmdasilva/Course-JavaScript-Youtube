# Lesson 2 Exercise - Numbers and Math
### Note: do these exercise in the console (right-click > Inspect > Console)

- 2a. At restarant, you order 1 soup for $10,3 burguers for $8 each, and 1 ice cream fro $5. Use javaScript to calculate the cost of the order.
...
- Finish: after finishing 2i remove the tosater from your cart.
